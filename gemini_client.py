...
"- MUST be highly descriptive, precise, and interview-ready\n"
"- NO word limit (allow full clarity over brevity)\n"
"- Use Title Case\n"
"- Clearly describe the core task, constraints, and context when needed\n"
"- Avoid vague or generic names like Data Structures And Algorithms or Coding Problem\n"
"- Use structure: Action + Object + Context + Technique (if applicable)\n"
"- Prefer detailed meaningful names like Find Longest Substring Without Repeating Characters Using Sliding Window\n"
"- Include key constraints or behavior if important (e.g., Thread-Safe, Idempotent, Distributed, Real-Time)\n"
"- Align naming style with real interview / LeetCode problem patterns\n"
"- Never merge multiple problems into one title\n"
"- Ensure each title uniquely identifies a single problem\n\n"
